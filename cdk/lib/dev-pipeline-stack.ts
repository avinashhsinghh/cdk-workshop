...
export class DevPipelineStack extends Stack {
    ...
    constructor(scope: Construct, id: string, props?:StackProps) {
        ...
        const sourceAction = new codepipeline_actions.GitHubSourceAction({
            ...
            owner: githubOwner,
            repo: repoName,
            oauthToken: SecretValue.secretsManager(awsSecretsGitHubTokenName),
            output: sourceOutput,
        ...
        const dockerBuild = new codebuild.PipelineProject(this, 'DockerCodeBuildProject', {
            ...
            buildSpec: codebuild.BuildSpec.fromObject({
                ...
                phases: {
                    pre_build: {
                        commands: 'aws ecr get-login-password --region ap-south-1 | docker login --username AWS --password-stdin 542636815093.dkr.ecr.ap-south-1.amazonaws.com',
                    },
                    build: {
                        commands: [
